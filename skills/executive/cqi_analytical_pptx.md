...
Native bridge for the installable Codex skill
`.codex/skills/cqi-analytical-pptx/SKILL.md`.

Use it when `presentation_agent` creates, edits, audits, releases, or explains
CQI/CQISense analytical PowerPoint decks.
...
- For ELAL analytical decks, additionally apply
  `.codex/skills/cqi-analytical-pptx/references/elal-analytical-profile.md`.
