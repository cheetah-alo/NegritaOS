...
This repository does not use Django REST Framework as its default backend stack.
Do not use this skill unless the user explicitly requests Django/DRF-specific guidance for a separate design or migration exercise.
name: django-drf
description: >
  Django REST Framework patterns.
    Trigger: When implementing DRF APIs (ViewSets, serializers, routers, permissions, filtersets).
license: Apache-2.0
metadata:
    author: generic
  version: "1.2.0"
