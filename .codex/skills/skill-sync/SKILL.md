...
metadata:
  author: generic
  version: "1.0"
  scope: [frontend]                              # Which AGENTS.md: frontend, backend, data_analytics, root
...
| `data_analytics` | `data_analytics/AGENTS.md` |
| `mcp_server` | `mcp_server/AGENTS.md` |

Skills can have multiple scopes: `scope: [frontend, backend]`
...
| Action | Skill |
|--------|-------|
| Creating/modifying frontend UI components | `frontend-web` |
```
