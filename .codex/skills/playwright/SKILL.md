...
For project UI E2E testing with authentication setup, environment variables, and test IDs, see:
- **Documentation**: [references/project-e2e.md](references/project-e2e.md)
