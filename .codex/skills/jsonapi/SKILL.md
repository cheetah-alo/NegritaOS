...
This repository does not treat JSON:API as the default API contract.
Do not use this skill unless the user explicitly requests JSON:API compliance work.
name: jsonapi
description: >
...
- **Testing**: Use `pytest` for test patterns
