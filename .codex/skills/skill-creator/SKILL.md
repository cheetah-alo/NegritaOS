...
| Project-specific | `{project}-{component}` | `app-backend`, `app-frontend` |
| Testing skill | `{component}-test` | `backend-test`, `frontend-test` |
...
| `license` | Yes | Use `Apache-2.0` unless your project requires otherwise |
| `metadata.author` | Yes | Project owner or org |
